...
<script type="text/babel">
  ...
  import scrollIntoView from 'topaz-ui/src/utils/scroll-into-view';
  import { getValueByPath, valueEquals, isIE, isEdge } from 'topaz-ui/src/utils/util';
  import NavigationMixin from './navigation-mixin';
  import { isKorean } from 'topaz-ui/src/utils/shared';
